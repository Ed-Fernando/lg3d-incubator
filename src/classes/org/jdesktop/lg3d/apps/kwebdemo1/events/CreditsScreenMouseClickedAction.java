/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/events/CreditsScreenMouseClickedAction.java,v 1.2 2005-06-24 19:56:54 paulby Exp $
...
import org.jdesktop.lg3d.apps.kwebdemo1.components.CreditsScreenC3D;
 ...
 */
public class CreditsScreenMouseClickedAction implements ActionNoArg
{
   ...
   * 
   * @param c3d  instance of the Component3D class that contains the
   *   method for handling the action.
   */
  public CreditsScreenMouseClickedAction(CreditsScreenC3D c3d)
  {
    this.creditsScreenC3D = c3d;
  }
  ...
  {
    creditsScreenC3D.handleMouseClick();
  }
