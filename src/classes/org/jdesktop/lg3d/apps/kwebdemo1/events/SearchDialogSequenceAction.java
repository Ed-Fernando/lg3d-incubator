/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/events/SearchDialogSequenceAction.java,v 1.2 2005-06-24 19:56:56 paulby Exp $
 ...
 * events generated during the search sequence. Whenever an animation occurs,
 ...
 */
public class SearchDialogSequenceAction implements ActionNoArg
{
   ...
   */
  public SearchDialogSequenceAction(Application app, int step)
  {
    this.app = app;
   ...
   * <code>searchDialogSequence(stepNumber)</code> method in the main
   * {@link org.jdesktop.lg3d.apps.kwebdemo1.Application Application} class.
   * </p>
   * 
  ...
  {
    app.searchDialogSequence(stepNumber);
  }
