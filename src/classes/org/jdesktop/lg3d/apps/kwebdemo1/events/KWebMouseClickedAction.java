/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/events/KWebMouseClickedAction.java,v 1.2 2005-06-24 19:56:55 paulby Exp $
 ...
 */
public class KWebMouseClickedAction implements ActionBooleanInt
{
   ...
   */
  public KWebMouseClickedAction(Application app)
  {
    this.app = app;
  }
   ...
   */
  public void performAction(LgEventSource source, boolean dblClick,
          int kNodeId)
  {
    ...
    if (kn != null)
      {
        ...
        app.nodeDialogSequence(1, kNodeId, kn);
      }
  }
