/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/events/StartupSequenceAction.java,v 1.2 2005-06-24 19:56:56 paulby Exp $
 ...
 */
public class StartupSequenceAction implements ActionNoArg
{
   ...
   */
  public StartupSequenceAction(Application app, int step)
  {
    this.app = app;
  ...
  {
    app.startupSequence(stepNumber);
  }
