...
public class Notepad extends JInternalFrame {
    ...
    public static Notepad _this;
    JPanel mainPanel;
    
    static {
        try {
            resources = ResourceBundle.getBundle ("conf.Notepad", 
						   Locale.getDefault ());
        } catch (MissingResourceException mre) {
            System.err.println ("conf/Notepad.properties not found");
        }
    }
    
    public Notepad () {
        super ("JWS Notepad", true, true, true, true);
        _this = this;
        try {
		...
		UIManager.getCrossPlatformLookAndFeelClassName ());
                // -- If you want the System L&F instead, comment out the above 
		...
		// -- UIManager.getSystemLookAndFeelClassName());
            ...
            Notepad._this.getContentPane ().setLayout (new BorderLayout ());
            ...
            mainPanel.add ("South", createStatusbar ());
            Notepad._this.getContentPane ().add (mainPanel);
            setSize (300,300);
            setLocation (350,350);
        } catch(Exception exp) {
            exp.printStackTrace ();
