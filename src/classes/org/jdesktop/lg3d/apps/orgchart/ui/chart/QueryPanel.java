 ...
 * @author cc144453
 */
public class QueryPanel extends Component3D
     ...
     */
    public QueryPanel(Chart3D orgChart) {
    ...
    private void createUI() {
        ...
        setAnimation(new NaturalMotionAnimation(Chart3D.ANIMATION_DURATION));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Iterator<Map> contacts = orgChart.search(searchText);
        orgChart.initializeTree(contacts);
    }
