...
/**
 * Esta clase encapsula la funcionalidad del boton Less Abstraction del Menu. 
 * 
 * @author Juan Feldman
 *
 */
public class GeonMenuCommandLessAbstraction extends GeonMenuCommand {
	 ...
	 */
	public GeonMenuCommandLessAbstraction(GeonMenu invoker, GeonFrameManager receiver, Object[] params) {
	...
	public void execute() {
		...
		receiver.lessAbstractionButton_click(buttonNumber);
		...
		geonWheel.increaseAbstractionLevel();
	}
