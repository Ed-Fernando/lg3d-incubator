...
public class CartModify  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest[] request;
    ...
    public CartModify(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.CartModifyRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">CartModify"));
