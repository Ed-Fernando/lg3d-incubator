...
public class ItemSearch  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest[] request;
    ...
    public ItemSearch(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.ItemSearchRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">ItemSearch"));
