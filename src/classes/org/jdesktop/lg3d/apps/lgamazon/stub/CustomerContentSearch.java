...
public class CustomerContentSearch  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest[] request;
    ...
    public CustomerContentSearch(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentSearchRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">CustomerContentSearch"));
