...
public class BrowseNodeLookup  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest[] request;
    ...
    public BrowseNodeLookup(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.BrowseNodeLookupRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">BrowseNodeLookup"));
