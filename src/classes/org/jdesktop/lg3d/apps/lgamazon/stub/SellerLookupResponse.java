...
public class SellerLookupResponse  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.Sellers[] sellers;
    ...
    public SellerLookupResponse(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.Sellers[] sellers) {
     ...
     * @return sellers
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.Sellers[] getSellers() {
        return sellers;
    }
     ...
     * @param sellers
     */
    public void setSellers(org.jdesktop.lg3d.apps.lgamazon.stub.Sellers[] sellers) {
        this.sellers = sellers;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.Sellers getSellers(int i) {
        return this.sellers[i];
    }

    public void setSellers(int i, org.jdesktop.lg3d.apps.lgamazon.stub.Sellers _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">SellerLookupResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", "Sellers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", "Sellers"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
