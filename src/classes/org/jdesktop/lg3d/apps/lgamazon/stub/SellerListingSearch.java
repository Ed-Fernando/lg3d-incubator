...
public class SellerListingSearch  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest[] request;
    ...
    public SellerListingSearch(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.SellerListingSearchRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">SellerListingSearch"));
