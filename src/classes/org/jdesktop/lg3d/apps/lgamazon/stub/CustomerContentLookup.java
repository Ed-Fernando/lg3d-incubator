...
public class CustomerContentLookup  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest[] request;
    ...
    public CustomerContentLookup(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.CustomerContentLookupRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">CustomerContentLookup"));
