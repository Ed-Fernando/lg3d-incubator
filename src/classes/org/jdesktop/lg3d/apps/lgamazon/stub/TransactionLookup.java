...
public class TransactionLookup  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest[] request;
    ...
    public TransactionLookup(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.TransactionLookupRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">TransactionLookup"));
