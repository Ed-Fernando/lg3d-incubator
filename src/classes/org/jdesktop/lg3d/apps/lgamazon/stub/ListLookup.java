...
public class ListLookup  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest[] request;
    ...
    public ListLookup(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.ListLookupRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">ListLookup"));
