...
public class ItemLookup  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest[] request;
    ...
    public ItemLookup(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.ItemLookupRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">ItemLookup"));
