...
public class CartGet  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest shared;
    private org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest[] request;
    ...
    public CartGet(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest shared,
           org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest[] request) {
     ...
     * @return shared
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest getShared() {
        return shared;
    }
     ...
     * @param shared
     */
    public void setShared(org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest shared) {
        this.shared = shared;
    }
     ...
     * @return request
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest[] request) {
        this.request = request;
    }

    public org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, org.jdesktop.lg3d.apps.lgamazon.stub.CartGetRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">CartGet"));
