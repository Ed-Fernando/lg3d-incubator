...
public class CartAddRequest  implements java.io.Serializable {
    ...
    private org.jdesktop.lg3d.apps.lgamazon.stub.CartAddRequestItems items;
    ...
    public CartAddRequest(
           ...
           org.jdesktop.lg3d.apps.lgamazon.stub.CartAddRequestItems items,
     ...
     * @return items
     */
    public org.jdesktop.lg3d.apps.lgamazon.stub.CartAddRequestItems getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(org.jdesktop.lg3d.apps.lgamazon.stub.CartAddRequestItems items) {
        this.items = items;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", "CartAddRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">CartAddRequest>Items"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
