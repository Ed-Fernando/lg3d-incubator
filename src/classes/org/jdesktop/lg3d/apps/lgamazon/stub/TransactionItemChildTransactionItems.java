/**
 * TransactionItemChildTransactionItems.java
 *
 */

package org.jdesktop.lg3d.apps.lgamazon.stub;

public class TransactionItemChildTransactionItems  implements java.io.Serializable {
    private org.jdesktop.lg3d.apps.lgamazon.stub.TransactionItem[] transactionItem;

    public TransactionItemChildTransactionItems() {
    }
    ...
    /**
     * Gets the transactionItem value for this TransactionItemChildTransactionItems.
     * 
    ...
    /**
     * Sets the transactionItem value for this TransactionItemChildTransactionItems.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransactionItemChildTransactionItems)) return false;
        TransactionItemChildTransactionItems other = (TransactionItemChildTransactionItems) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransactionItemChildTransactionItems.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2006-03-08", ">>TransactionItem>ChildTransactionItems"));
