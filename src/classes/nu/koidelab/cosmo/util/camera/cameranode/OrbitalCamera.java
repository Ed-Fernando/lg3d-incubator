...
public class OrbitalCamera extends NaturalMotionCameraNode {
    ...
    public void movePOR(boolean toFuture){
        ...
        //* switch travel distance of point of regards with
        switch (mode) {
        case Calendar.YEAR:
        ...
        case Calendar.HOUR_OF_DAY:
        	currentPosition.add(Calendar.MINUTE, direction * 15);
            break;
        default:
            /* Do nothing */
            return;
